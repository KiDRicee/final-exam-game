...
sprites.onOverlap(SpriteKind.Player, SpriteKind.TheHive, function (sprite, otherSprite) {
    ...
    [img`
        ...
        ......3333333333333333311
        ......33aaaaa3333aaaaa311
        .....33333aaa3333aaa33313
        ....3333333333333aa333313
        ..333333333333333aa333333
        ..33333333333333333333333
        .......333333333333333333
        ......3333..33333..3333..
        ......333...33333..3333..
    ...
    Bee.setPosition(mySprite.x + -90, mySprite.y - 90)
    Bee.follow(mySprite)
})
...
game.splash("Grab All Krabby Patties and Avoid ALL Jellyfish Hives")
game.splash("If You Do NOT Grab ALL Krabby Patties, You Lose")
